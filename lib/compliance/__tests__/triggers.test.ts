...
function room(type: string, id = "r1"): Room {
  return { id, name_en: type, name_ar: null, type, polygon: [[0, 0], [3, 0], [3, 3], [0, 3]], area_m2: 9, ceiling_h_m: 2.9, unroofed: false, area_derived_m2: null, derived_note: null, level_mm: null, height_mm: null, spec: null, dims_derived: false, site_reference: false, disposition: null, derived_fields: [] };
}
